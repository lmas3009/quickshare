  ...
  return (
    <div className="w-full flex items-center justify-center poppins">
      <div className="w-full flex flex-col">
        <Header />
        <div
          className="flex flex-col sm:flex-row poppins bg-white text-white shadow-md shadow-black m-5 p-5 items-center justify-between rounded-md"
          style={{
        ...
        >
          <div className="flex flex-col items-center sm:items-start justify-center gap-1">
            <p className="text-lg">{data.projectname}</p>
          </div>
        </div>
